                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link" href="buyer_dashboard.php">profile </a>
    ...
    <div class="account user name"><?php echo $username; ?></div>
        ...
        <div class="horizontal"></div>  
         ...
         <?php
            ...
            $sql = "SELECT  p.title AS product_title, p.image ,o.return_date
            FROM returns o
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<p>" . $row['return_date'] . "</p>";
         
                    echo "</div>";
                    echo "<div class='return-button'>";
                    // echo "<button type='button' id='return_order'  name='return_order' class='btn btn-primary'>Return</button>";
                    // echo "</div>";
                    echo "</div>";
                    echo "</div>";
                }
            } else {
                echo "No no item have been returned yet";
            }
